...
getSecond(){
    axios.get('/accounts/getAllThird').then(response => {
        this.setState({AccountData : response.data, dataLoading: false});
...
const second = [...this.state.AccountData];
...
getSub(e,data){
    axios.get('/accounts/getAllSub/'+data.value).then(response => {
        this.setState({second: response.data});
    })
}
deleteAccount(id){
                ...
                <Grid.Row>
                    <Grid.Column width="4">
                             <Form onSubmit={this.sendData}>
                                ...
                                <Dropdown placeholder='Select Main Head' fluid search selection options={this.state.main} onChange={this.getSub}/>
                                </Form.Field>
                                <Form.Field>
                                <label>Sub Head</label>
                                <Dropdown placeholder='Select Sub Head' fluid search selection options={this.state.second} onChange={this.getCode}/>
                                </Form.Field>
                                <Form.Field>
                                <label>Code</label>
