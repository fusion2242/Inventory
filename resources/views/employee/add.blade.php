      ...
      <section class="content">
         ...
         <div class="box box-info">
            <div class="box-header with-border">
               <h3 class="box-title">Add Employee Here</h3>
            </div>
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                     <div class="col-md-4">
                        ...
                        <input type="password"  id="pass" class="form-control" placeholder="Put Strong Password">
                     </div>
                     <div class="col-md-4">
                        <label>Repeat Password</label>
                        <input type="password"  id="re_pass" class="form-control" placeholder="Put Strong Password">
               ...
               <div class="row">
                  <div class="form-group">
                     <div class="col-md-4">
                        ...
                        <input type="number"  id="phone" class="form-control" placeholder="e.g. 0333-1231231">
                     </div>
               ...
               <div class="box-footer">
                  <button type="submit" style="margin-right:-9px;" class="btn btn-primary pull-right submit">Submit</button>
               </div>
               <!-- /input-group -->
            </div>
            <!-- /.box-body -->
