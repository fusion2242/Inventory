...
<html>
               ...
               <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo $c->customer_discount?></td>
                        <td><?php echo $c->date?></td>
                        <td>
                           <a data-toggle="modal"  data-target="#modal_form_vertical">
                           <i class="glyphicon glyphicon-pencil edit" style="color:Dimgray;"  data-id="<?php echo $c->id?>"></i>  
                           </a> 
                           &nbsp
                           &nbsp
                           <a href="/customer/delete/<?php echo $c->id?>">
   ...
   <!-- /.content-wrapper -->
   @include('footer')  <!-- Add the sidebar's background. This div must be placed
   ...
   <script>
        ...
        id = $(this).data("id");
         ...
         $.ajax({
             ...
             success: function(response){
                ...
                $('#cust_id').val(data[0].customer_id);
                $('#cust_name').val(data[0].customer_name);
                $('#cust_email').val(data[0].customer_email);
                $('#cust_phone').val(data[0].customer_phone);
      ...
      post.customer_name = $('#cust_name').val();
      post.customer_email = $('#cust_email').val();
      post.customer_phone = $('#cust_phone').val();
      post.customer_id = $('#cust_id').val();
      post._token = $('#token').val(); 
      
      var url = '/customer/updated'+'/'+id;
      $.ajax({
