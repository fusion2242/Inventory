...
<html lang="en">
   <head>
      ...
      <title>Bank Recieving Voucher</title>
      <!-- Global stylesheets -->
         ...
         <div>
            <div class="panel-heading">
               <h6 class="panel-title text-center" style="font-weight:bold;">
                  AL MEHRAN BUILDERS PAK (PVT) LTD <br> B-4, BLOCK 16, GULSHAN-E-IQBAL, KARACHI <br> Bank Recieving Voucher
               </h6>
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="col-md-3">
                              <div class="form-group">
                                 ...
                                 <input type="text"  name="name"  id="po"
