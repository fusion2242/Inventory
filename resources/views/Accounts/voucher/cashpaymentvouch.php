...
<head>
 ...
 <script type="text/javascript" src="<?php echo base_url()?>assets/jquery.num2words.js"></script>
            ...
            <div class="page-header" style="margin: 0; border-bottom: 0; background-color: #fff;">
              <div class="page-header-content">
                <div class="page-title">
                  <h5>
                    <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vouchures</span> - Cash Payment Vouchers
                                  </h5>
                </div>
              </div>
            </div>
    ...
    <div>
        <div class="panel-heading">
          <h6 class="panel-title text-center" style="font-weight:bold;">
            AL MEHRAN BUILDERS PAK (PVT) LTD <br> B-4, BLOCK 16, GULSHAN-E-IQBAL, KARACHI <br> CASH PAYMENT VOUCHER 
          </h6>
            <div class ="col-md-4 text-left">
               <span class="" >Date:&nbsp&nbsp<input type="text" class="daterange-basic" name=""></span>
            </div>
   ...
   <!--                        <input type="text" name="Debit" class="form-control" placeholder="Enter Debit" style="width: 166px;">
      ...
      -->
              ...
              <div class="row">
                  ...
                  <input type="text" name="Mobile"  name="designation" placeholder="Debit" class="form-control amount">
                ...
                <br>
                 ...
                 <div class="newDebit"></div>
                  <tr class="even creditTr">
                    ...
                    <td></td>
                    <td class="amountinwords"><input type="text" name="credit" class="form-control credit" placeholder="Enter Credit" readonly></td>
                  </tr>
         ...
         <div class="panel-body">
          <div class="form-group">
              <div class="col-md-12">
                        ...
                        <input type="text" id="narration" name="name"
              ...
              <div class="col-md-12">
                 <div class="col-md-3">
                      <div class="form-group">
                        ...
                        class="form-control" id="paidto" placeholder="Enter Name">
                    </div>
                  </div>
                   <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text"  name="name"
                        class="form-control" id="behalfof" placeholder="Enter Name">
                    </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                        <label>Against:</label>
                        <input type="text"  name="name"
                        class="form-control" id="against" placeholder="Enter Name">
                    </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                        <label>Mobile #:</label>
                        <input type="text"  name="name"
                        class="form-control" id="mobile" placeholder="Enter number">
                    </div>
                  </div>
                </div>
               ...
               <div class="col-md-12">
                  <div class="col-md-3">
                      <div class="form-group">
                        <label>C.N.I.C. #:</label>
                        <input type="text"  name="name"
                        class="form-control" id="cnic" placeholder="Enter your CNIC">
                    </div>
                  </div>
          ...
          <div class="col-md-12">
              ...
              <button value="submit" style="margin-bottom:30px; margin-right:15px;" class="btn btn-primary submitrecord">Save</button>
...
$(document).on("change", ".amount", function() {
    ...
    $(".credit").val(sum);
    var url = '<?php echo site_url("accounts/voucher/convert_number"); ?>'+'/'+sum;
              $.ajax({
...
$('.submitrecord').on('click',function(){
    ...
    post.credit = $('.credit').val();
        ...
        var url = '<?php echo site_url("accounts/voucher/submitcashpaymentvoucher") ?>';
